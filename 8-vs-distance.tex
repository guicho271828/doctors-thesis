...
critical at all because we can simply switch the behavior depending on
whether the domain contains zerocost actions or not. 
Coverage results in \reftbl{tbl:dtg-summary-sum} shows the total of zerocost and
benchmark domains. The dynamic configuration which switches the behavior achieves the highest
coverage overall.
...
\begin{table}[htbp]
 ...
 \caption{
 Coverage results with \textbf{ \lmcut for computing $f$ and inadmissible distance-to-go heuristics for tiebreaking, on 620 zerocost instances}. We highlight the best results when the difference between the maximum and the mininum coverage exceeds 2.
 }
...
\begin{table}[htbp]
 ...
 \caption{
 Coverage results with \textbf{ \mands for computing $f$ and inadmissible distance-to-go heuristics for tiebreaking, on 620 zerocost instances}. We highlight the best results when the difference between the maximum and the mininum coverage exceeds 2.
 }
...
\begin{table}[htbp]
 ...
 \caption{
 Coverage results with \textbf{ \lmcut for computing $f$ and inadmissible distance-to-go heuristics for tiebreaking, on 1104 standard IPC benchmark instances}. We highlight the best results when the difference between the maximum and the mininum coverage exceeds 2.
 }
...
\begin{table}[htbp]
 ...
 \caption{
 Coverage results with \textbf{ \mands for computing $f$ and inadmissible distance-to-go heuristics for tiebreaking, on 1104 standard IPC benchmark instances}. We highlight the best results when the difference between the maximum and the mininum coverage exceeds 2.
 }
