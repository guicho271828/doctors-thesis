...
However, actual implementation may differ due to dynamic update to $f_{\mit{min}}$.}
as a BFS with
\[
...
tiebreaking, while they focus on bounded-suboptimal search rather than optimal search.
% 
