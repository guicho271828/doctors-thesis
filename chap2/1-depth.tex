...
\chapter[How to Explore the Final Frontier]{Tiebreaking Strategies for \astar Search: How to Explore the Final Frontier}
...
As defined in \refsec{sec:preliminaries}, if two nodes are  on the same plateau, 
