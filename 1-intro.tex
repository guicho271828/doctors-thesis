...
\begin{enumerate}
 ...
 \item A new, thorough empirical analysis of the behavior of depth-based diversification in 
       \refsec{sec:depth-based-evaluation}.
 \item We propose a new framework for treating \astar as a sequence of satisficing searches on a set of $f$-cost plateaus (\refsec{discussion}), and based on this new framework, we propose and evaluate tie-breaking strategies which incorporates distance-to-go estimates
