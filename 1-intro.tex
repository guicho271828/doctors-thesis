...
which was shown to improve tie-breaking performance,
...
\begin{enumerate}
 ...
 \item A new, thorough empirical analysis of the behavior of depth-based diversification in 
       \refsec{sec:depth-based-evaluation}.
 \item We propose a framework for treating \astar as a sequence of satisficing searches on a set of $f$-cost plateaus (\refsec{sec:discussion}), and based on this framework, we propose and evaluate tie-breaking strategies which incorporates distance-to-go estimates
       \refsec{sec:distance-to-go}.  
%Also, we included an empirical
%       evaluation of the use of inadmissible FF heuristics as part of
%       tie-breaking criterion, and its combination with the
