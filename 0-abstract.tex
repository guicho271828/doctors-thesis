...
\begin{abstract}
  Best-first search algorithms such as \astar need to apply tie-breaking strategies in order to decide which node to expand when multiple search nodes have the same evaluation score.
 We investigate and improve tie-breaking strategies for
 cost-optimal search using \astar.
