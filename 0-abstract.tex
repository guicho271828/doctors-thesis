...
\begin{abstract}
  When multiple search nodes have the same evaluation score, best-first search algorithms such as A* need to apply tie-breaking strategies in order to decide which node to expand.
