...
\section{Embedding Distance-to-Go in Admissible Search}
...
\subsection{Distance-to-Go Estimates with Default Tie-Breaking}
% added subsection to highlight the new combination of depth + d2go
...
\subsection{Distance-to-Go Estimates with Depth Diversification}
...
\section[Evaluation]{Evaluation of Distance-to-Go Estimates as Tie-Breaking Criteria for Admissible Search}
...
\subsection{Evaluation on Zerocost Domains}
...
\subsection{Evaluation on Standard IPC Domains}
...
\begin{tabular}{|p{4.2em}|p{7.5em}||p{9.4em}|p{9.7em}|}
\hline
 Primary Heuristics & Zerocost domains
                    & Zerocost IPC 
                    & Positive-cost IPC \\
 & & (\pddl{Cybersec}, \pddl{Openstacks}) & \\ \hline
\hline
...
\begin{table}[htb]
 ...
 \caption{
 % 
 Summary Results: Coverage comparison, the total number of instances in IPC and Zerocost domains (1724), 
 solved in 5min, 4GB, with several sorting strategies, plus a dynamic configuration strategy.  $[f,h,\fifo],
