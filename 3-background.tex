...
The first solution found by the algorithm is guarantee to have the optimal cost $f=f^*$ because 
any nodes with $f(n) = k$ are expanded after all nodes with $f(n) < k$ are expanded.
