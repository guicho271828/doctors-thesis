...
%of focus of the heuristic search literature. % unnecessary - already stated above that default tiebreaking has not been investigated in-depth; and before that, we already said that there's ``folklore'', and that the erly literature was agnostic.
