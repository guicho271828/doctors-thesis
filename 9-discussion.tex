...
($t$: horizon).  This latter behavior also connects model-based approaches to Iterative Deepening \astar
...
\begin{figure}[htbp]
 ...
 \caption{Concept of IDA* and model-based planning as a sequence of satisficing searches.}
...
% 
Our results and the new interpretation, \textbf{optimizing search is a sequence of satisficing searches on each plateau},
