\clearpage 
\section{Discussion: Reformulation of A* as a Series of Satisficing Search Episodes}
...
The stratey of iterative search over a sequence of horizons in model-based planning is somewhat analogous to our view of A* as a sequence of satisficing search over a set of plateaus.
...
This view of A* search as a series of satisficing searches also reminiscent of the behavior of 
iterative deepening A* \cite{korf1985depth}, which executes a series of satisficing searches with a $f$-cost limit which increases on each iteration. 
However, ``A*-as a sequence of satisficing search'' differs from IDA* in that IDA*, in order to achieve linear memory usage, repeats prevoius work on each iteration.

Reformulating A* as a sequence of satisficing searches 
points to  an interesting direction for future work.
