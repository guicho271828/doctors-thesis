...
Indeed, if entire nodes are expanded, there are surely more nodes in larger depth.
However, the set of nodes actually expanded are biased to the shallower region.
