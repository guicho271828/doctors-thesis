...
We significantly shortened the proof and now it does not have an individual section now.
...
We turned it into a theorem and made the explanation more detailed.
