...
Thus, the Zerocost versions of the instances with finite search graphs, remains finite after modification.
This is the case with domain-independent planning under PDDL semantics (closed world assumption).
Since on a finite graph \astar is complete regardless of the tie-breaking strategy,
