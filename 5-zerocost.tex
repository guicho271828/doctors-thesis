...
number of instances differ to each other. In both \lmcut and \mands
heuristics, we observed a significant difference between these two
domains.  For example, when \lmcut is used, the coverage was
significantly lower in 10 domains, while more instances were solved in
5 domains.
