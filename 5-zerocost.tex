...
Existing empirical analyses mainly focus on the performance difference caused by using a plan length heuristic vs plan cost heuristic for inadmissible heuristic search \cite{thayer2009using,thayer2011bounded,cushing2010cost,richter2011lama}, not the performance difference caused by the target cost function in cost-optimal search. The use of plan length heuristics is further discussed in \refsec{sec:distance-to-go}.
