...
While above literature also show some theories on why this happens, \citeauthor{aghighi2015} \citeyear{aghighi2015,aghighi2016} fully complemented the full theory behind this, using the parameterized complexity of planning domains, showing % can't extrapolate too strongly from problem class complexity results to specific instances 
