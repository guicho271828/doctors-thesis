...
\subsubsection{Combining Distance-to-go Estimates with Default Tiebreaking and Depth Diversity} % added subsection to highlight the new combination of depth + d2go
