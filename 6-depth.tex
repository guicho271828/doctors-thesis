...
\refig{fig:plateau-depiction} (subfigure 1). It is equivalent to the $g$-value which is
...
\begin{figure}[htbp]
 ...
 (\textbf{Subfigure 2}) \lifo tiebreaking strategy implies a depth-first behavior in a
 plateau, which could miss the solution concentrated near the entrance.
 (\textbf{Subfigure 3}) \fifo tiebreaking strategy implies a breadth-first behavior in a
 plateau, which could fail to reach a solution in the deeper region within the time limit.
 ...
 suppressing the excessive exploration to the deeper region. This balances the exploration and exploitation.
 }
