...
The uniform samplig behavior of  \ro behaves very similar to \fifo, and is insufficient to achieve the level of diversity provided by our depth diversification tiebreaking.
...
In contrast, our depth diversification policy gives expands nodes at $d=1$ and $d=2$ with equal probability.
...
Aside from accidental biases, there may other nontrivial biases such as some form of symmetry among states which can be removed using some tiebreaking criterion $X$.
