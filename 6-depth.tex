...
Below, we show that the presence of 0-cost edges is the necessary condition
for non-zero depths, which allows depth-diversification to affect the order of expansion.
