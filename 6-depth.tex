...
This depth-based diversification is significantly different from \ro the strategy which simply selects a random node from the OPEN list.
Actually, the global randomization \ro behaves very similar to \fifo, and is insufficient to achieve the level of diversity provided by our depth diversification tiebreaking.
...
In contrast, our depth diversification gives $d=1,2$ an equal chance of expansion.
