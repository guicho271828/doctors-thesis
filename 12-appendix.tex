...
\clearpage
\section[Additional Figures for \refig{fig:expansion-ratio}]{Additional Figures for \refig{fig:expansion-ratio}: $\lifo$ Default Tiebreaking}
...
\clearpage
\section[Additional Figures for \refig{fig:depth-histogram}]{Additional Figures for \refig{fig:depth-histogram}: More Histograms for the Size of Final Plateaus}
...
\begin{figure}[htb]
\centering
\includegraphics[width=0.4\linewidth]{img/output-lmcut/miconic-up/p79-0.pdf}
\includegraphics[width=0.4\linewidth]{img/output-lmcut/pathways-fuel/p03-0.pdf}\\
\includegraphics[width=0.4\linewidth]{img/output-lmcut/pipesnt-pushstart/p06-0.pdf}
\includegraphics[width=0.4\linewidth]{img/output-lmcut/pipesworld-pushend/p06-0.pdf}\\
\includegraphics[width=0.4\linewidth]{img/output-lmcut/psr-small-open/p46-0.pdf}
\includegraphics[width=0.4\linewidth]{img/output-lmcut/rovers-fuel/p07-0.pdf}
...
\begin{figure}[htb]
\centering
\includegraphics[width=0.4\linewidth]{img/output-lmcut/scanalyzer-analyze/p04-0.pdf}
\includegraphics[width=0.4\linewidth]{img/output-lmcut/storage-lift/p11-0.pdf}\\
\includegraphics[width=0.4\linewidth]{img/output-lmcut/tidybot-motion/p16-0.pdf}
\includegraphics[width=0.4\linewidth]{img/output-lmcut/tpp-fuel/p08-0.pdf}\\
...
\clearpage
\section[Additional Figures for \refig{fig:depth-histogram4}]{Additional Figures for \refig{fig:depth-histogram4}: More Histograms for the Size of Non-final Plateaus}
...
\begin{figure}[htb]
\centering
\includegraphics[width=0.4\linewidth]{img/output-lmcut/depot-fuel/p07-1.pdf}
\includegraphics[width=0.4\linewidth]{img/output-lmcut/driverlog-fuel/p04-1.pdf}\\
\includegraphics[width=0.4\linewidth]{img/output-lmcut/zenotravel-fuel/p07-1.pdf}
\includegraphics[width=0.4\linewidth]{img/output-lmcut/floortile-ink/p02-14.pdf}\\
\includegraphics[width=0.4\linewidth]{img/output-lmcut/mprime-succumb/p12-1.pdf}
