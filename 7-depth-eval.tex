...
% \includegraphics{img/output-lmcut/cybersec/p07-95.pdf}
 \caption{(Page 4/5) Depth distribution of Openstacks and Cybersec instances in the final ($\plateau{f^*,0}$) and non-final plateaus ($\plateau{f^*,h}, h\not=0$). In Cybersec p06, although $\plateau{f^*,0}$ is small, \fifo and \ro behaved poorly on $\plateau{f^*,1}$, and also \lifo behaved poorly on $\plateau{f^*,5}$. The same behavior was observed in p07.}
