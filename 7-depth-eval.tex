...
by the management of depth buckets become negligeble even in the case of \mands.
...
\refig{fig:depth-histogram} to \refig{fig:depth-histogram3}
 show the results on several exampler
instances in various zerocost domains. Also,
 \refig{fig:depth-histogram4} shows the same results on standard
...
\begin{figure}[htbp]
% \includegraphics{img/depth/openstacks-opt11/p04.pdf}
