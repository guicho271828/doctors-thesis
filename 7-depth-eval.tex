...
As shown in \refig{fig:expansion-ratio}, the number of evaluation of \mands heuristics per seconds has significantly decreased,
...
% low-level overhead.
% 
It also supports our analysis in \refsec{sec:depth-and-nonzero-cost} that depth diversification
...
Finally we note that, if we look at the per-domain results in Zerocost domains,
