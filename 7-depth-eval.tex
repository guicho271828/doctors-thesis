...
\refig{fig:plateau}).  Most other instances are unaffected by depth-based tiebreaking.  Thus, our method offers a
...
% 
As we show in \refig{fig:expansion-ratio}, this is because the low-level overhead of depth-based tiebreaking
