...
\begin{table}[htbp]
 ...
 depth-based tiebreaking ($x$-axis) on \lmcut and \mands heuristics. On \mands, node evaluation rate often becomes
 twice as slower due to depth-based tiebreaking. This is because the node evaluation of \mands is an order of
 magnitude faster than \lmcut, and the overhead of managing depth-based tiebreaking queue is non-negligible on
 \mands. }
 % 
...
Similar phenomena were observed in several domains (which are included in \refig{fig:depth-histogram5}).
