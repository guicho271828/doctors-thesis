...
\reftbl{tbl:lmcut-zerocost-full} and \reftbl{tbl:mands-zerocost-full} shows the number of {620 Zerocost
...
\reftbl{tbl:lmcut-ipc-full} shows the number of {1104 standard IPC benchmark instances} solved by the configuration using \lmcut
...
Finally, the per-domain results in Zerocost domains (\reftbls{tbl:lmcut-zerocost-full}{tbl:mands-zerocost-full}\todo*{reftables}) show that 
