...
shown in \reftbl{tbl:summary-std} (Detailed results are in \reftbl{tbl:lmcut-ipc-std} and \reftbl{tbl:mands-ipc-std}.
...
The effect of the choice of 2nd-level default tiebreaking strategies (\lifo vs.
