...
As noted above in Section \ref{sec:astar-background}, the current standard practice is to use a tie-breaking criterion which uses the $h$-value of the nodes. However, to our knowledge, the need for $h$-based tie-breaking has not been previously empirically investigated.
