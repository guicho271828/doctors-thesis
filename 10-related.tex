...
\citeauthor{cushing2010cost} \citeyear{cushing2010cost} investigates ``$\varepsilon$-cost
...
admissible search cannot, unless it is the plateau with $f=f^*$.
...
and $h_2$ is used to break ties among nodes with the same $h_1$ --- $[h_1,h_2,\fifo]$, in effect.
...
In contrast, we discussed solely on the tiebreaking, and the focus of our paper is how tiebreaking enables the efficient search on the plateau created by the earlier levels of sorting criteria.
