...
In this paper, we investigated the tie-breaking strategies for cost-optimal search using \astar.  
...
% \begin{enumerate} % It looks bad when an entire section is just an enumerated list, 
 ...
 domains, which contains many 0-cost actions which makes the cost-optimal planning strictly harder than without.
